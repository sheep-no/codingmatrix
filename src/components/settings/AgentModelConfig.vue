...
.config-table th, .config-table td { padding: 12px 16px; border: 1px solid #e0e0e0; text-align: center; }
.config-table th { background: #f5f7fa; font-weight: 600; white-space: nowrap; }
...
.complexity-badge.simple { background: #e8f5e9; color: #2e7d32; }
.complexity-badge.small { background: #e3f2fd; color: #1565c0; }
.complexity-badge.medium { background: #fff3e0; color: #ef6c00; }
.complexity-badge.large { background: #fce4ec; color: #c62828; }
.complexity-badge.enterprise { background: #f3e5f5; color: #7b1fa2; }

.model-select { width: 100%; padding: 6px 8px; border: 1px solid #dcdfe6; border-radius: 4px; font-size: 13px; background: #fff; cursor: pointer; }
.model-select:hover { border-color: #409eff; }
.model-select:focus { border-color: #409eff; outline: none; }

.model-readonly { font-size: 13px; color: #606266; }

/* 降级链 */
.fallback-chains { display: flex; flex-direction: column; gap: 16px; margin-bottom: 24px; }
.chain-card { border: 1px solid #e0e0e0; border-radius: 8px; padding: 16px; background: #fafafa; }
.chain-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px; }
.chain-name { font-size: 15px; font-weight: 600; color: #303133; }
.chain-save-btn { padding: 4px 16px; background: #409eff; color: #fff; border: none; border-radius: 4px; font-size: 13px; cursor: pointer; }
.chain-save-btn:hover { background: #66b1ff; }
...
.chain-index { display: inline-flex; align-items: center; justify-content: center; width: 24px; height: 24px; border-radius: 50%; background: #409eff; color: #fff; font-size: 12px; font-weight: 600; flex-shrink: 0; }
.chain-remove-btn { background: none; border: none; cursor: pointer; color: #909399; padding: 4px; display: flex; align-items: center; }
.chain-remove-btn:hover { color: #f56c6c; }
.chain-add-btn { display: flex; align-items: center; gap: 4px; padding: 6px 12px; background: #ecf5ff; color: #409eff; border: 1px dashed #b3d8ff; border-radius: 4px; font-size: 13px; cursor: pointer; margin-top: 4px; }
...
.error-type-item { display: flex; align-items: center; gap: 12px; padding: 8px 12px; border: 1px solid #e0e0e0; border-radius: 6px; background: #fafafa; }
.error-type-name { font-size: 13px; font-weight: 600; color: #303133; min-width: 100px; }

.config-info { display: flex; gap: 32px; margin-bottom: 24px; padding: 16px; background: #f5f7fa; border-radius: 8px; }
...
.reload-btn { display: flex; align-items: center; gap: 8px; padding: 8px 20px; background: #409eff; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 14px; }
