...
describe('PPTPreview quality report', () => {
  ...
  it('submits actual edits with the preview version and opens the new task', async () => {
    ...
    expect(wrapper.text()).toContain('第 1 页 96 分')
    expect(wrapper.text()).toContain('第 2 页 80 分')
    expect(wrapper.text()).toContain('文本溢出')
    expect(wrapper.text()).toContain('第 2 页：文本超出文本框边界')
    expect(wrapper.text()).not.toContain('slide-1 96')
    ...
    expect(wrapper.find('.slide-edit-actions').exists()).toBe(true)
