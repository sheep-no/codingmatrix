...
class TestWebSearchE2E:
    ...
    @pytest.mark.asyncio
    async def test_code_endpoint_with_search_enabled(self, auth_headers, client):
    ...
    @pytest.mark.asyncio
    async def test_code_endpoint_with_search_disabled(self, auth_headers, client):
    ...
    @pytest.mark.asyncio
    async def test_code_endpoint_default_search_behavior(self, auth_headers, client):
    ...
    @pytest.mark.asyncio
    async def test_search_enhancement_integration(self, auth_headers, client):
        """测试查询词增强集成"""
        # 技术问题的查询词增强
    ...
    @pytest.mark.asyncio
    async def test_search_response_time(self, auth_headers, client):
        """测试搜索响应时间"""
        import time
...
class TestFrontendParameterPassing:
    ...
    @pytest.mark.asyncio
    async def test_enable_search_parameter_accepted(self, auth_headers, client):
    ...
    @pytest.mark.asyncio
    async def test_search_count_parameter(self, auth_headers, client):
        """测试 search_count 参数"""
        # 测试不同搜索数量
...
class TestSearchErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_search_timeout_handling(self, auth_headers, client):
        """测试搜索超时处理"""
        payload = {
    ...
    @pytest.mark.asyncio
    async def test_invalid_model_with_search(self, auth_headers, client):
        """测试无效模型 + 搜索参数"""
        payload = {
            "prompt": "测试",
            "model": "invalid-model",
    ...
    @pytest.mark.asyncio
    async def test_empty_prompt_with_search(self, auth_headers, client):
        """测试空提示词 + 搜索参数"""
        payload = {
            "prompt": "",
            "model": "Qwen/Qwen2.5-7B-Instruct",
...
class TestSearchScenarios:
    ...
    @pytest.mark.asyncio
    async def test_technical_question_search(self, auth_headers, client):
        """技术问题搜索场景"""
        payload = {
    ...
    @pytest.mark.asyncio
    async def test_error_fix_search(self, auth_headers, client):
        """错误修复搜索场景"""
        payload = {
    ...
    @pytest.mark.asyncio
    async def test_tutorial_search(self, auth_headers, client):
        """教程搜索场景"""
        payload = {
    ...
    @pytest.mark.asyncio
    async def test_news_search(self, auth_headers, client):
        """新闻搜索场景"""
        payload = {
...
class TestStreamingSearch:
    ...
    @pytest.mark.asyncio
    async def test_streaming_search_enabled(self, auth_headers, client):
        """测试流式输出 + 搜索启用"""
        payload = {
    ...
    @pytest.mark.asyncio
    async def test_streaming_search_disabled(self, auth_headers, client):
        """测试流式输出 + 搜索禁用"""
        payload = {
