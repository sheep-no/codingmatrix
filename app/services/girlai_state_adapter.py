...
async def append_conversation_turn(
    ...
    user_message = await append_message(db, session.id, user_id, "user", user_content, metadata)
    assistant_message = await append_message(db, session.id, user_id, "assistant", assistant_content, metadata)
