...
生成 dependency_graph.json 供 Agent 在修改代码时查询受影响文件。

用法:
    python scripts/build_dependency_graph.py [--target app/] [--output dependency_graph.json]
"""
...
def main():
    ...
    parser.add_argument('--output', default='dependency_graph.json', help='输出文件')
