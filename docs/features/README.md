...
- [项目功能介绍](PROJECT-INTRODUCTION.md) - 平台功能概览和架构说明
- [动态供应商](DYNAMIC-PROVIDERS.md) - 自定义 base_url + 协议类型接入任意 API 服务
- [免费模型管理](MODEL-MANAGER.md) - 内置模型查看、切换和管理
- [Agent 功能](agent.md) - Agent 协作开发、项目生成、Git 集成
